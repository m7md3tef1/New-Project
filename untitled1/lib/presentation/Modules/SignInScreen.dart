                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          const  Image(image: AssetImage('images/facebook.png',),width: 50,height: 50,),
                          const  Image(image: AssetImage('images/Apple.png'),width: 50,height: 50,),
                          Padding(
                            padding:const  EdgeInsets.all(8.0),
                            child: InkWell(
                                onTap: (){
                                ...
                                child:const Image(image: AssetImage('images/phone.jpg'),width: 50,height: 50,)),
                          ),
                        ],
                      )
                    ],
